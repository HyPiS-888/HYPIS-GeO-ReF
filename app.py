"""
HyPIS Ug  v7.3  — Bug-Fixed
═══════════════════════════════════════════════════════════════════════════════
FIXES in v7.3 (over v7.2):
...
Author: Prosper BYARUHANGA · HyPIS App v7.3 · FAO-56 PM
═══════════════════════════════════════════════════════════════════════════════
"""
...
<span class="hx-sub">HydroPredict · IrrigSched · Uganda Multi-Location IWR v7.3</span>
</div></div>
<div class="hx-auth">by: Prosper <strong>BYARUHANGA</strong>
&nbsp;·&nbsp; HyPIS App v7.3 &nbsp;·&nbsp; FAO-56 PM · Soil-adjusted MAD · Uganda</div>
...
with tab1:
    ...
    st.caption(
        ...
        f"FAO-56 PM v7.3 · Irrigation trigger: Dr ≥ RAW AND Pe < ETc · "
...
st.markdown("---")
st.caption(
    f"HyPIS Ug v7.3 · {SITE_NAME} ({LAT}°, {LON}°, {ELEV} m) · "
